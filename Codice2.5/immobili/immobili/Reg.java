...
//AGENZIA-----------------------------------------------------------------------------------
	public void inserisci_agenzia() {
		...
		if(t.telefono.matches("[0-9]+")==false) {
			System.out.println("attenzione il numero di telefono non � valido");
		}
...
//PRIVATO-------------------------------------------------------------------------	
	public void inserisci_privato() {
		...
		do {
		 ...
		 t.et�=Integer.parseInt(in.nextLine());
	...
	public void estrai() {
		...
		if(z.type==1) {
			System.out.println("PRIVATO"+newline+"Nome:  "+z.Nome + newline +"Cognome:  "+z.Cognome +newline+ "Et�:  "+ z.et�+newline +"Email:  "+ z.email+newline+"Codice fiscale:  "+ z.cod_fisc+newline+
